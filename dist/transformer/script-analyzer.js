...
exports.extractRunesFromScript = extractRunesFromScript;
/**
 * Extract runes and functions from script AST
 */
function extractRunesFromScript(script) {
 ...
 */
function analyzeNode(node, analysis, source) {
    // Import declaration
 ...
 */
function analyzeVariableDeclarator(node, analysis, source) {
 ...
 */
function analyzePropsPattern(pattern, analysis, source) {
 ...
 * Analyze $effect() call
 */
function analyzeEffect(node, analysis, source) {
 ...
 */
function analyzeFunctionDeclaration(node, analysis, source) {
 ...
 */
function extractDependencies(node, analysis) {
 ...
 */
function getExpressionSource(node, source) {
    // Defensive: validate inputs
 ...
 */
function analyzeImportDeclaration(node, analysis, source) {
    // Defensive: validate node
    if (!node || typeof node !== 'object') {
        return;
    }
 ...
 */
function analyzeTypeScriptInterface(node, analysis, source) {
    // Defensive: validate node
    if (!node || typeof node !== 'object') {
        return;
    }
 ...
 */
function analyzeTypeScriptTypeAlias(node, analysis, source) {
    // Defensive: validate node
    if (!node || typeof node !== 'object') {
        return;
    }
