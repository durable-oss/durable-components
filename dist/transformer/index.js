...
function transform(ast) {
    ...
    if (ast.script) {
        ...
        const scriptAnalysis = (0, script_analyzer_1.extractRunesFromScript)(ast.script);
 ...
 */
function extractRefsFromTemplate(template) {
    const refs = new Set();
    function walk(node) {
