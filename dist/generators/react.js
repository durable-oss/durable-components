...
function generateReact(ir) {
    ...
    // Combine all parts
    const code = (0, code_gen_1.joinStatements)(reactImports, externalImports, types, propsInterface, component);
    return {
        code
    };
}
 ...
 */
function generateReactImports(ctx) {
