/**
 * Type definitions for vite-plugin-durable-components
 */

declare module '@durable/compiler/vite-plugin' {
  import type { Plugin } from 'vite';
  import type { CompilerTarget, StyleMode } from '@durable/compiler';
